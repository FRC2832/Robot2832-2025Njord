...
public class SwerveSubsystem extends SubsystemBase {
          ...
          ChassisSpeeds speeds =
              new ChassisSpeeds(
                  ...
                  controller.headingCalculate(
                      getHeading().getRadians(), getTargetYaw(target).getRadians()));
  ...
  */
  ...
  public void setMaximumSpeed(
      double maximumSpeedInMetersPerSecond, double maxRotationalVelocityRadiansPerSecond) {
    swerveDrive.setMaximumAllowableSpeeds(
        maximumSpeedInMetersPerSecond, maxRotationalVelocityRadiansPerSecond);
  }
  ...
  public void addVisionMeasurement(
    ...
    if (publisher == null) {
      publisher =
          NetworkTableInstance.getDefault().getStructTopic("Frame Pose", Pose2d.struct).publish();
    }
  ...
  public Command finePosition(Pose2d targetPose) {
    return this.driveToPose(targetPose).andThen(new FinePosition(this, targetPose));
  }
