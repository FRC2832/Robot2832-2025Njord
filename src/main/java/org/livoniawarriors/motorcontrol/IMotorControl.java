...
public interface IMotorControl {
  ...
  /**
   * Set the motor to a specific voltage. This is prefered for smoother control through battery
   * issues
   *
  ...
  /**
   * Scale factors > 1 slow down the motor velocity (like 10:1 makes the output of 6000RPM down to
   * 600)
   *
   * @param factor
   */
  ...
  /**
   * Set the motor to the specified RPM. This ignores the Velocity and Accel Max constants from PID
   * constants.
   *
   * @param rpm
   */
   ...
   *
   * @return An object to cast to the correct motor type (depends on what motor this interface
   *     implemented)
   */
  Object getBaseMotor();
