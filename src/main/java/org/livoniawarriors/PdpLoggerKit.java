...
/**
 * This class asks AdvantageKit what the PDP currents are and puts them in a 
 * NT table with the channel names, not numbers.  Channels are named so that
 * we don't need a dictionary when knowing what channel his what device.  Using
 * AK's conduit API so that we don't have to requery the CAN device.
 */
