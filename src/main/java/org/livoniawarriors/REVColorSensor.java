...
/**
 * This class wraps the REV ColorSensorV3 class, as the color sensor uses I2C reads that sometime
 * lock the Rio. See sampleUsage() to see how to use the sensor to match to a color. There is no
 * periodic function with this class as the reads are done on a background thread.
 */
public class REVColorSensor {
  ...
  /**
   * Get the currently seen color. Works best when within 2 inches and perpendicular to surface of
   * interest.
   *
   * @return Color seen
   */
